...
//PCIe-9814
#define PCIe_9814       0x35
//PCIe-9834
#define PCIe_9834       0x37
//PXIe-9834
#define PXIe_9834       0x39
...
#define ErrorInvalidParameter	       -72

#define ErrorNotDAQSteppedMode       -80

#define ErrorBufAddrNotQuadDWordAlignment   -90

#define ErrorDeviceIsRunning	 -106

//Error number for calibration API
#define ErrorCalAddress		     -110
#define ErrorInvalidCalBank	   -111
//Error code for Clock
#define ErrorPLLNotLocked		 	 -126
#define ErrorCLKNotPresent		 -127
#define ErrorDDRInitFailed		 -128
#define ErrorSelfTestFailed		 -130
...
#define WD_AI_TRGSRC_ANA_MCHs  0x07
...
#define	WD_PLL_REF_EXT		  WD_PLL_REF_EXT10
#define	WD_PXIe_CLK100		  0x6
#define WD_PLL_REF_PXIeCLK100	  0x6
#define	WD_DBoard_TimeBase	  0x7 
...
void * __stdcall WD_BufferAllocEx (U16 wCardNumber, size_t Size);
...
I16 __stdcall WD_GetFPGAVersion(U16 wCardNumber, U32* version);
I16 __stdcall WD_GetFPGAVersionDateCode(U16 wCardNumber, U32* version, U64* datecode);
I16 __stdcall WD_GetSerialNumber(U16 wCardNumber, U8 *SerialString, U8 numberOfElements, U8* actualread);
I16 __stdcall WD_SetLoggingDataCountPerFile(U16 wCardNumber, U16 task, U64 datacnt);
I16 __stdcall WD_GetLoggingDataCountPerFile (U16 wCardNumber, U16 task, U64 *datacnt);
I16 __stdcall WD_Self_Test(U16 wCardNumber, I16 *selftestResult, U16 inputcharcnt, char* selftestMessageStr, U16 *retcharcnt);
/*---------------------------------------------------------------------------*/
...
I16 __stdcall WD_AnaTrig_Config (U16 wCardNumber, U16 NumChans, U16* Chans, U16* trigPol, F64* anaTriglevel);
...
I16 __stdcall WD_AI_VoltScale32 (U16 CardNumber, U16 AdRange, I32 reading, F64 *voltage);
...
I16 __stdcall WD_AI_Array_Scale (U16 wCardNumber, U16 numRanges, U16 *rangeList, U16 width, void *readingArray, F64 *voltageArray, I32 count);
...
I16 __stdcall WD_AI_EventCallBack_x64 (U16 wCardNumber, I16 mode, I16 EventType, ULONG_PTR callbackAddr);
I16 __stdcall WD_AI_EventCallBackEx_x64 (U16 wCardNumber, I16 mode, I16 EventType, ULONG_PTR callbackAddr, void *pUserData);
...
I16 __stdcall WD_MeasureStats(U16 wCardNumber, U16 wNumChans, U16 *chans, U16 item, void* valBuf);

I16 __stdcall WD_AI_ContBufferSetup64 (U16 wCardNumber, void *pwBuffer, U64 dwReadCount64, U16 *BufferId);
I16 __stdcall WD_AI_ContBufferSetup32S64 (U16 wCardNumber, void *pwBuffer, U64 dwReadCount, U16 *BufferId);
I16 __stdcall WD_AI_ContBufferLock64 (U16 wCardNumber, void *pwBuffer, U64 dwReadCount64, U16 *BufferId);
I16 __stdcall WD_AI_InitialMemoryAllocated64 (U16 CardNumber, U64 *MemSize);
I16 __stdcall WD_AI_ContReadChannel64 (U16 CardNumber, U16 Channel,
               U16 BufId, U64 ReadScans64, U32 ScanIntrv, U32 SampIntrv, U16 SyncMode);
I16 __stdcall WD_AI_ContReadMultiChannels64 (U16 CardNumber, U16 NumChans, U16 *Chans,
               U16 BufId, U64 ReadScans64, U32 ScanIntrv, U32 SampIntrv, U16 SyncMode);
I16 __stdcall WD_AI_ContScanChannels64 (U16 CardNumber, U16 Channel,
               U16 BufId, U64 ReadScans64, U32 ScanIntrv, U32 SampIntrv, U16 SyncMode);
I16 __stdcall WD_AI_ContReadChannelToFile64 (U16 CardNumber, U16 Channel, U16 BufId,
               U8 *FileName, U64 ReadScans64, U32 ScanIntrv, U32 SampIntrv, U16 SyncMode);
I16 __stdcall WD_AI_ContReadMultiChannelsToFile64 (U16 CardNumber, U16 NumChans, U16 *Chans,
               U16 BufId, U8 *FileName, U64 ReadScans64, U32 ScanIntrv, U32 SampIntrv, U16 SyncMode);
I16 __stdcall WD_AI_ContScanChannelsToFile64 (U16 CardNumber, U16 Channel, U16 BufId,
             U8 *FileName, U64 ReadScans64, U32 ScanIntrv, U32 SampIntrv, U16 SyncMode);
I16 __stdcall WD_AI_ContVScale64 (U16 wCardNumber, U16 adRange, void *readingArray, F64 *voltageArray, I64 count64);
I16 __stdcall WD_AI_ContVScaleEx64 (U16 wCardNumber, U16 adRange, U16 width, void *readingArray, F64 *voltageArray, I64 count64);
I16 __stdcall WD_AI_Array_Scale64 (U16 wCardNumber, U16 numRanges, U16 *rangeList, U16 width, void *readingArray, F64 *voltageArray, I64 count64);
I16 __stdcall WD_AI_AsyncCheck64 (U16 CardNumber, BOOLEAN *Stopped, U64 *AccessCnt64);
I16 __stdcall WD_AI_AsyncClear64 (U16 CardNumber, U64 *StartPos64, U64 *AccessCnt64);
I16 __stdcall WD_AI_AsyncClearEx64 (U16 CardNumber, U64 *StartPos64, U64 *AccessCnt64, U32 NoWait);
I16 __stdcall WD_AI_DMA_TransferBySize64 (U16 wCardNumber, F32 timeLimit,  U16 BufId, U64 dwReadCount64, U64 *numRead64, U64 *dataNotTransferred64, U8 *complete);
...
I16 __stdcall _9820_Auto_Calibration_EClk(U16 wCardNumber, U16 bank);
/*---------------------------------------------------------------------------*/
//DIO
